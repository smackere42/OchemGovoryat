...
const phrases = [{
    ...
    phrases: [
        ...
        {
            title: 'Ты что, собрался наследить в истории?',
        ...
        {
            title: 'Обожду покаместь, любезный...',
        ...
        {
            title: 'Сидит сейчас в небесной канцелярии новый начальник отдела московской погоды, пьёт чай и мысленно себя хвалит: успел. Успел к началу зимы разложить снег. Global warming, my ass.',
