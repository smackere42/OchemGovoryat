      ...
      <div id='modal' className="modalHide">
        <div className={styles.modalWrapper}>
            ...
            <div id="logo" className={styles.logo}>
                <a tabIndex={0} href='https://drugoedelo.ru/' title='Другое дело' alt='Другое дело сылка' target="_blank"><div className={styles.logo}></div></a>
            </div>
            <div className={styles.textContainer} role="textbox">
              ...
              <div tabIndex={0} className={styles.standrtText} alt="В 2022 году мы собрали больше 1000 подслушанных фраз от участников проекта Другое Дело со всех городов России.">В 2022 году мы собрали больше 1000 подслушанных фраз от участников проекта Другое Дело со всех городов России.</div>
              ...
              <div tabIndex={0} className={styles.standrtText} alt="Организатор: Другое Дело"> <a className={styles.bold}>Организатор:</a><br/><a href='https://vk.com/drugoedelo' target="_blank">Другое Дело</a></div>
              ...
              <div tabIndex={0} className={styles.standrtText}>Заходи в <a href='https://vk.com/app7785085?utm_campaign=generic&utm_term=all&utm_source=dd&utm_content=button&utm_medium=website&mt_click_id=mt-zdras5-1654304530-1806938819&mt_creative=button&mt_network=dd&mt_sub1=website&mt_campaign=generic&mt_adset=all#mt_campaign=generic&mt_adset=all&mt_network=dd&mt_creative=button&mt_sub1=website' className={styles.bold} target="_blank">приложение</a>. Выполняй задания. Получай баллы и обменивай их на призы, которые достаются тебе за то, что ты уделяешь внимание своей жизни.</div>
              <div tabIndex={0} className={styles.standrtTextBreaker}>Это ведь совсем Другое Дело!</div>
              <div tabIndex={0} className={styles.standrtText}><a className={styles.bold}>Партнер:</a><br/><a href='https://vk.com/sloooshai' target="_blank">Sloooshai</a></div>
              <div tabIndex={0} className={styles.standrtTextBreaker}>Проект Sloooshai — ребята, которые слушают город и расклеивают стикеры с подслушанными фразами в том месте, где они были услышаны. Sloooshai хотят подчеркивать милые, необычные и иногда смешные формулировки, которые люди используют в обычных разговорах, без подготовки. Они не выверенные, а потому очень естественные. Такие слова — самые живые.</div>
              <div tabIndex={0} className={styles.standrtTextBreaker}><a className={styles.bold}>Над проектом работали:</a><br/>Идея: Тристан Иван<br/>Авторы и редакторы: Зуева Аксинья Зуева, Озерова Виктория, Полетаева Александра, Тристан Иван</div>
              ...
              <div tabIndex={0} className={styles.standrtText}><a className={styles.bold}>Контактная информация:</a><br/>Сайт: <a className={styles.bold} href='https://www.drugoedelo.ru' target="_blank">drugoedelo.ru</a><br/>Группа в ВК: <a className={styles.bold} href='https://vk.com/drygoedelo' target="_blank">vk.com/drygoedelo</a><br/>Электронная почта: <a className={styles.bold} href='mailto:support.dd@rsv.ru' target="_blank">support.dd@rsv.ru</a></div>
              <div tabIndex={0} className={styles.standrtTextBreaker}></div>
              <div tabIndex={0} className={styles.standrtText}>Дополнительная информация о проекте находиться <a href='https://github.com/smackere42/OchemGovoryat' className={styles.bold}  target="_blank">здесь</a></div>
            </div>
            <div className='modalShare'>
              <div alt='Поделиться' className='shareLinks bold'>Поделиться:</div> 
