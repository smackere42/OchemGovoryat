      ...
      <div id='modal' className="modalHide">
        <div className={styles.modalWrapper}>
            ...
            <div className={styles.textContainer} role="textbox">
              ...
              <div tabIndex={0} className={styles.standrtText} alt="В 2022 году мы мы собрали больше 1000 подслушанных фраз от участников проекта Другое Дело со всех городов России.">В 2022 году мы мы собрали больше 1000 подслушанных фраз от участников проекта Другое Дело со всех городов России.</div>
              ...
              <div tabIndex={0} className={styles.standrtTextBreaker}><a className={styles.bold}>Над проектом работали:</a><br/><br/>Идея: Тристан Иван<br/>Авторы и редакторы: Зуева Аксинья Зуева, Озерова Виктория, Полетаева Александра, Тристан Иван</div>
              ...
              <div tabIndex={0} className={styles.standrtText}><a className={styles.bold}>Контактная информация:</a></div>
              <div tabIndex={0} className={styles.standrtText}>Сайт: <a href='https://www.drugoedelo.ru' target="_blank">https://www.drugoedelo.ru</a><br/>Группа в ВК: <a href='https://vk.com/drygoedelo' target="_blank">https://vk.com/drygoedelo</a><br/>Электронная почта: support.dd@rsv.ru</div>
