      ...
      <div id='modal' className="modalHide">
        <div className={styles.modalWrapper}>
            ...
            <div className={styles.textContainer} role="textbox">
              ...
              <div tabIndex={0} className={styles.standrtText} alt="Организатор: Другое Дело)">Организатор:<br/><a href='https://vk.com/drugoedelo' target="_blank">Другое Дело</a> (https://vk.com/drugoedelo)</div>
              ...
              <div tabIndex={0} className={styles.standrtText}>Партнер:<br/><a href='https://vk.com/sloooshai' target="_blank">Sloooshai</a> (ссылка https://vk.com/sloooshai)</div>
              ...
              <div tabIndex={0} className={styles.standrtText}>Дополнительеая информация о проекте находиться здесь : <a href='https://github.com/smackere42/OchemGovoryat' target="_blank">https://github.com/smackere42/OchemGovoryat</a></div>
            </div>
